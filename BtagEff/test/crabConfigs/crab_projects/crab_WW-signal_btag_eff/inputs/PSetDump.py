...
process.HighPtMuons = cms.EDProducer("HighPtMuonSelector",
...
process.bestJet = cms.EDFilter("LargestPtCandViewSelector",
    maxNumber = cms.uint32(1),
    src = cms.InputTag("goodJets")
)


process.electronIDs = cms.EDFilter("ElectronID",
...
process.goodAK4Jets = cms.EDFilter("jetID",
    ID = cms.string('loose'),
    filter_flag = cms.bool(False),
...
process.goodAK4JetsNotUsed = cms.EDFilter("PFJetIDSelectionFunctorFilter",
...
process.goodJets = cms.EDFilter("jetID",
    ID = cms.string('loose'),
    filter_flag = cms.bool(False),
...
process.goodJetsNotUsed = cms.EDFilter("PFJetIDSelectionFunctorFilter",
    filterParams = cms.PSet(
        quality = cms.string('LOOSE'),
        version = cms.string('FIRSTDATA')
    ),
...
process.selectedPatJetsAK8ByPt = cms.EDFilter("PATJetSelector",
...
process.BtagAnalyzer = cms.EDAnalyzer("BTaggingEffAnalyzer",
    ...
    PtMax = cms.double(530.0),
    PtMin = cms.double(30.0),
    PtNBins = cms.int32(10)
)


process.muSequence = cms.Sequence(process.HighPtMuons+process.looseMuons+process.tightMuons)


process.eleSequence = cms.Sequence(process.electronIDs+process.looseElectrons+process.tightElectrons)


process.fatJetsSequence = cms.Sequence(process.selectedPatJetsAK8ByPt+process.selectedPatJetsAK8+process.cleanJets+process.goodJets+process.bestJet)


process.electrons = cms.Sequence(process.electronIDs+process.tightElectrons)


process.AK4JetsSequence = cms.Sequence(process.selectedPatJetsAK4+process.cleanAK4Jets+process.goodAK4Jets)
